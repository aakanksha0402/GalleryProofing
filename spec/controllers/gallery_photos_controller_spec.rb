...
RSpec.describe GalleryPhotosController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all gallery_photos as @gallery_photos" do
      ...
      expect(assigns(:gallery_photos)).to eq([gallery_photo])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested gallery_photo as @gallery_photo" do
      gallery_photo = GalleryPhoto.create! valid_attributes
      get :show, {:id => gallery_photo.to_param}, valid_session
      expect(assigns(:gallery_photo)).to eq(gallery_photo)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new gallery_photo as @gallery_photo" do
      ...
      expect(assigns(:gallery_photo)).to be_a_new(GalleryPhoto)
    end
  end
  ...
  describe "GET #edit" do
    it "assigns the requested gallery_photo as @gallery_photo" do
      gallery_photo = GalleryPhoto.create! valid_attributes
      get :edit, {:id => gallery_photo.to_param}, valid_session
      expect(assigns(:gallery_photo)).to eq(gallery_photo)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new GalleryPhoto" do
        expect {
          post :create, {:gallery_photo => valid_attributes}, valid_session
        }.to change(GalleryPhoto, :count).by(1)
      end

      it "assigns a newly created gallery_photo as @gallery_photo" do
        post :create, {:gallery_photo => valid_attributes}, valid_session
        expect(assigns(:gallery_photo)).to be_a(GalleryPhoto)
        expect(assigns(:gallery_photo)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved gallery_photo as @gallery_photo" do
        post :create, {:gallery_photo => invalid_attributes}, valid_session
        expect(assigns(:gallery_photo)).to be_a_new(GalleryPhoto)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested gallery_photo" do
        gallery_photo = GalleryPhoto.create! valid_attributes
        put :update, {:id => gallery_photo.to_param, :gallery_photo => new_attributes}, valid_session
      ...
      it "assigns the requested gallery_photo as @gallery_photo" do
        gallery_photo = GalleryPhoto.create! valid_attributes
        put :update, {:id => gallery_photo.to_param, :gallery_photo => valid_attributes}, valid_session
        expect(assigns(:gallery_photo)).to eq(gallery_photo)
      end
    ...
    context "with invalid params" do
      it "assigns the gallery_photo as @gallery_photo" do
        gallery_photo = GalleryPhoto.create! valid_attributes
        put :update, {:id => gallery_photo.to_param, :gallery_photo => invalid_attributes}, valid_session
        expect(assigns(:gallery_photo)).to eq(gallery_photo)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested gallery_photo" do
      gallery_photo = GalleryPhoto.create! valid_attributes
      expect {
        delete :destroy, {:id => gallery_photo.to_param}, valid_session
      }.to change(GalleryPhoto, :count).by(-1)
    end
    ...
    it "redirects to the gallery_photos list" do
      gallery_photo = GalleryPhoto.create! valid_attributes
      delete :destroy, {:id => gallery_photo.to_param}, valid_session
      expect(response).to redirect_to(gallery_photos_url)
    end
  end
