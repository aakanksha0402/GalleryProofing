...
RSpec.describe "automation_series_email_templates/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit automation_series_email_template form" do
    render

    assert_select "form[action=?][method=?]", automation_series_email_template_path(@automation_series_email_template), "post" do
