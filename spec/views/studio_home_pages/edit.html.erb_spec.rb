...
RSpec.describe "studio_home_pages/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit studio_home_page form" do
    render

    assert_select "form[action=?][method=?]", studio_home_page_path(@studio_home_page), "post" do
