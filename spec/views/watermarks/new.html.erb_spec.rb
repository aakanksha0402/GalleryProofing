...
RSpec.describe "watermarks/new", type: :view do
  before(:each) do
    assign(:watermark, Watermark.new(
      :name => "MyString",
      :text_name => "MyString",
      :font_set => "MyString",
      :color => "MyString",
  ...
  it "renders new watermark form" do
    render

    assert_select "form[action=?][method=?]", watermarks_path, "post" do
