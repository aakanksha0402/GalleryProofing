...
RSpec.describe "gallery_layouts/new", type: :view do
  before(:each) do
    assign(:gallery_layout, GalleryLayout.new(
      :name => "MyString",
  ...
  it "renders new gallery_layout form" do
    render

    assert_select "form[action=?][method=?]", gallery_layouts_path, "post" do
