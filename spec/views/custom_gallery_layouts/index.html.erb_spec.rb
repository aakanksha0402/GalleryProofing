...
RSpec.describe "custom_gallery_layouts/index", type: :view do
  before(:each) do
    assign(:custom_gallery_layouts, [
      CustomGalleryLayout.create!(
        :name => "Name",
  ...
  it "renders a list of custom_gallery_layouts" do
    render
