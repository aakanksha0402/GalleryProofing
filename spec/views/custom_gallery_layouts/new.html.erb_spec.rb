...
RSpec.describe "custom_gallery_layouts/new", type: :view do
  before(:each) do
    assign(:custom_gallery_layout, CustomGalleryLayout.new(
      :name => "MyString",
  ...
  it "renders new custom_gallery_layout form" do
    render

    assert_select "form[action=?][method=?]", custom_gallery_layouts_path, "post" do
